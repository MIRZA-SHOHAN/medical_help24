                ...
                <div class="card">
                    ...
                    <form action="save_doctor" method="post" >
                        @csrf
                            ...
                            <select class="form-control form-select nice-select" id="post-categories" name="custom1" style="display: none;">
                            ...
                            <div class="nice-select form-control form-select" tabindex="0">
                                ...
                                <ul class="list">
                                    <li data-value="hosiptal" class="option">Hospitals</li>
                                    <li data-value="doctors" class="option selected focus">Doctors</li>
                                    <li data-value="fitness" class="option">Fitness Centers</li>
                                    <li data-value="pharmacy" class="option">Pharmacies</li>
                                    <li data-value="clinic" class="option">Clinics</li>
                                    <li data-value="bloodbank" class="option">Blood Banks</li>
                                </ul>
                            </div>
                        </div> -->
                        <div class="card-body custom-card">
                            <div class="post-content active" id="hosiptal" style="display: none;">
                                <div class="form-group"><label class="form-label text-dark">Name</label> <input type="text" class="form-control" placeholder="Enter Name" /></div>
                                <div class="form-group"><label class="form-label text-dark">Phone Number</label> <input type="number" class="form-control" placeholder="Enter Number" /></div>
                                <div class="form-group"><label class="form-label text-dark">Address</label> <textarea class="form-control" name="example-textarea-input" rows="3" placeholder="text here.."></textarea></div>
                                <div class="form-group">
                                    <label class="form-label text-dark">Set Timings</label>
                                    <select class="form-control form-select nice-select" style="display: none;">
                                ...
                                <div class="post-content" id="doctors" style="display: block;">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group"><label class="form-label text-dark">Hospital Name</label> <input type="text" class="form-control" placeholder="Enter Hospital Name" /></div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group"><label class="form-label text-dark">Dr. Name</label> <input type="text" class="form-control" placeholder="Enter  Name" /></div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group"><label class="form-label text-dark">Degree</label> <input type="text" class="form-control" placeholder="eg.,MBBS,Phd" /></div>

                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group"><label class="form-label text-dark">Specialties</label> <input type="text" class="form-control" placeholder="eg., Gynecologist" /></div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-group"><label class="form-label text-dark">Consultency Fee</label> <input type="text" class="form-control" placeholder="eg., Gynecologist" /></div>
                            ...
                            <div class="post-content" id="fitness" style="display: none;">
                                <div class="form-group"><label class="form-label text-dark">Name</label> <input type="text" class="form-control" placeholder="Enter Name" /></div>
                                <div class="form-group"><label class="form-label text-dark">Address</label> <textarea class="form-control" name="example-textarea-input" rows="3" placeholder="text here.."></textarea></div>
                                <div class="form-group">
                                    <label class="form-label text-dark">Set Timings</label>
                            ...
                            <div class="post-content" id="pharmacy" style="display: none;">
                                <div class="form-group">
                                    <div class="form-group"><label class="form-label text-dark">Name</label> <input type="text" class="form-control" placeholder="Enter Name" /></div>
                                    <div class="form-group"><label class="form-label text-dark">Phone Number</label> <input type="number" class="form-control" placeholder="Enter Number" /></div>
                                    <div class="form-group"><label class="form-label text-dark">Address</label> <textarea class="form-control" name="example-textarea-input" rows="3" placeholder="text here.."></textarea></div>
                            ...
                            <div class="post-content" id="clinic" style="display: none;">
                                <div class="form-group"><label class="form-label text-dark">Name</label> <input type="text" class="form-control" placeholder="Enter Name" /></div>
                                <div class="form-group"><label class="form-label text-dark">Address</label> <textarea class="form-control" name="example-textarea-input" rows="3" placeholder="text here.."></textarea></div>
                                <div class="form-group"><label class="form-label text-dark">Phone Number</label> <input type="number" class="form-control" placeholder="Enter Number" /></div>
                                <div class="form-group">
                            ...
                            <div class="post-content" id="bloodbank" style="display: none;">
                                <div class="form-group"><label class="form-label text-dark">Name</label> <input type="text" class="form-control" placeholder="Enter Name" /></div>
                                <div class="form-group">
                                    <label class="form-label text-dark">Set Timings</label>
                                    <select class="form-control form-select nice-select" style="display: none;">
                        ...
                        <div class="card-footer"><a href="javascript:void(0);" class="btn btn-success btn-primary">Submit Now</a></div>
                    </form>
