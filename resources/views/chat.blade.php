					...
					<div class="col-lg-12 col-md-12">
						<div class="hero__part">
							<div class="hero__left">
								...
								<button class="custom_btn animate__animated animate__fadeInUp animate__delay-900ms" id="chatWidget">Get Started</button>

							</div>
							<div class="hero__right">
								<form autocomplete="off" action="#" method="POST">
									<textarea name="#" id="chat_text" cols="30" rows="10"  /></textarea>
									<input type="button" id="chatWidget2" data-toggle="modal" data-target="#exampleModalLong"  value="Ask Question" />
									{{-- onclick='openWidget()' --}}
...
$(document).ready(function () {
	$(document).on('click', '#chatWidget', function (event) {
      event.preventDefault();
		$(".chat_widget").css("display", "block");
	});
	$(document).on('click', '#chatWidget2', function (event) {
      event.preventDefault();
		$(".chat_widget").css("display", "block");
	});
	$(document).on('click', '.cross', function (event) {
      event.preventDefault();
		$(".chat_widget").css("display", "none");
	});
});
</script>
@endsection