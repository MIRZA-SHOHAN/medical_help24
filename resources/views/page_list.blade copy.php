    ...
    <div class="container">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Hopitals</li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="mb-lg-0">
                    <div class="">
                        <div class="item2-gl">
                            <div class="mb-0">
                                <div class="">
                                    <div class="p-5 bg-white item2-gl-nav d-flex d-none">
                                            ...
                                            <div class="d-md-flex">
                                                <div class="item-card9-img">
                                                    <div class="item-card9-imgs">
                                                        ...
                                                        <img alt="img" class="cover-image" src="{{ asset('frontend/images/0-24.jpg') }}" />
                                                    </div>
                ...
                <div class="card mb-0">
                    ...
                    <div class="card-body product-filter-desc">
                        <div class="product-filter-icons text-center">
                            <a class="facebook-bg" href="javascript:void(0);"><i class="fab fa-facebook-f" style="margin-top:10px"></i></a> <a class="twitter-bg" href="javascript:void(0);"><i class="fab fa-twitter" style="margin-top:10px"></i></a>
                            <a class="google-bg" href="javascript:void(0);"><i class="fab fa-google" style="margin-top:10px"></i></a> <a class="dribbble-bg" href="javascript:void(0);"><i class="fab fa-dribbble" style="margin-top:10px"></i></a>
                            <a class="pinterest-bg" href="javascript:void(0);"><i class="fab fa-pinterest" style="margin-top:10px"></i></a>
                        </div>
                    </div>
                </div>
            </div>
