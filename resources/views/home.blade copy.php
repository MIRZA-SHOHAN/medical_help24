					...
					<div class="col-lg-12 col-md-12"> 
						<div class="hero__part">
							<div class="hero__left">
								...
								<a href="https://api.leadconnectorhq.com/widget/bookings/bobbyg5o6n1x" target="_blank" class="animate__animated animate__fadeInUp animate__delay-900ms" onclick='openWidget1()'>Get Started</a>
							</div>
							<div class="hero__right">
								<form autocomplete="off" action="#" method="POST">
									<textarea name="#" id="chat_text" cols="30" rows="10"></textarea>
									<input type="button" id="conversation-badge" onclick='openWidget()' value="Ask Question" />
				...
				<div class="col-lg-12 col-md-12">
					<div class="demand__part">
						...
						<div class="demand__left">
							...
							<a href="{{$section6->link_action}}"><button class="custom_btn" onclick='openWidget()'>Start Chat</button></a>
