          ...
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">               
                ...
                <form action="save_testimonial" method="post" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">                       
                          ...
                          <input type="text" name="institute" class="form-control" id="">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">                       
                            ...
                            <input type="text" name="review_title" class="form-control" id="" >
                        </div>
                        <div class="col-md-4">                       
                          <label for="" style="margin-top: 10px">Review Details</label>
                          <input type="text" name="review_details" class="form-control" id="">
                        </div>
                      
                        <div class="col-md-4">                       
                          <label for="" style="margin-top: 10px;">Ratings</label>
                          <input type="text" name="ratings" class="form-control" id="" >
                        </div>
                    </div>
