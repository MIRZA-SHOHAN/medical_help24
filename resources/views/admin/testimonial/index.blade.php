...
@section('main_content')    
  ...
  <div class="page-content container container-plus">
    ...
    <div class="page-header pb-2">
      ...
      <a href="add-testimonial"class="btn btn-default px-3 text-95 radius-round border-2 brc-black-tp10 float-left">
         Add New
      </a>
    </div>  
                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
                      <tr>
                        ...
                        <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm"> Designation</th>								
                        <th  class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm"> Review Title</th>								
                      ...
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td class="align-middle">
                          <span class="d-none d-lg-inline">
                              <a  title="Edit" href="edit-testimonial/{{$item->id}}" class="v-hover">
                                  <i class="fa fa-edit text-blue-m1 text-120"></i>
                              </a>
                          </span>

                          <span class="d-lg-none text-nowrap">
                              <a title="Edit" href="edit-testimonial/{{$item->id}}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
