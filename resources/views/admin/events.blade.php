...
@section('main_content')    
  ...
  <div class="page-content container container-plus">
    ...
    <div class="page-header pb-2">
      ...
      <a href="add-event"class="btn btn-default px-3 text-95 radius-round border-2 brc-black-tp10 float-left">
         Add New
      </a>
    </div>   
                      ...
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td class="align-middle">
                          <span class="d-none d-lg-inline">
                              <a  title="Edit" href="edit-event/{{$item->id}}" class="v-hover">
                                  <i class="fa fa-edit text-blue-m1 text-120"></i>
                              </a>
                          </span>

                          <span class="d-lg-none text-nowrap">
                              <a title="Edit" href="edit-event/{{$item->id}}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
                          ...
                          <span class="d-none d-lg-inline">
                              <a data-rel="tooltip" title="Delete" href="/delete_event/{{$item->id}}" onclick="confirmDelete()" class="v-hover">
