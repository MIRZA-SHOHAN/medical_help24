          ...
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              <div class="page-content container container-plus">
				...
				<a href="add-page" class="btn btn-white px-3 text-95 radius-round border-2 brc-black-tp10 float-right">
                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    @foreach($data as $item)                                   
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td>	
                          @if($item->image != null )
                            <img src="{{ URL::asset('storage/app/public/'.$item->image.'') }}" height="50px" width="80px;">
                          @else
                            <img src="{{asset('frontend/images/no-image.png')}}" height="50px" width="80px;" class="product-image">
                          @endif   
                        </td> 
                        ...
                        <td class="align-middle">
                          <span class="d-none d-lg-inline">
                              <a  title="Edit" href="edit-page/{{$item->id}}" class="v-hover">
                                  <i class="fa fa-edit text-blue-m1 text-120"></i>
                              </a>
                          </span>

                          <span class="d-lg-none text-nowrap">
                              <a title="Edit" href="edit-page/{{$item->id}}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
                              ...
                              <div class="modal-dialog modal-dialog-centered modal-confirm">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="" class="btn btn-danger delete-page">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>                              
