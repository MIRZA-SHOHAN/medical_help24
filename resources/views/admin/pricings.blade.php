...
@section('main_content')    
  ...
  <div class="page-content container container-plus">
    ...
    <div class="page-header pb-2">
      ...
      <a href="add-pricing"class="btn btn-default px-3 text-95 radius-round border-2 brc-black-tp10 float-left">
         Add New
      </a>
    </div>  
                      ...
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td class="align-middle">
                          <span class="d-none d-lg-inline">
                              <a  title="Edit" href="edit-pricing/{{$item->id}}" class="v-hover">
                                  <i class="fa fa-edit text-blue-m1 text-120"></i>
                              </a>
                          </span>

                          <span class="d-lg-none text-nowrap">
                              <a title="Edit" href="edit-pricing/{{$item->id}}" class="btn btn-outline-info shadow-sm px-4 btn-bgc-white">
                              ...
                              <div class="modal-dialog modal-dialog-centered modal-confirm">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <a href="" class="btn btn-danger delete-pricing">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>                              
