    ...
    <div class="container">
        ...
        <div class="row">	           
            ...
            <div class="col-md-4 col-lg-4 mt-60 class_side_bar">
                ...
                @endphp 
                @if ($event)
                    <a href="{{URL::to('event')}}/{{$event->id}}" class="btn_prev" title="Previous Class">< {{$event->title}}</a>
                @endif
                ...
                @endphp 
                @if ($event)
                    <a href="{{URL::to('event')}}/{{$event->id}}" class="btn_next" title="Next Class">{{$event->title}} ></a>
                @endif
