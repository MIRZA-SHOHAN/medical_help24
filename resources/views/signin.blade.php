      ...
      <div class="row m-0">
        <div class="col-12 p-0">    
          <div class="login-card login-dark">
            <div>
              <div><a class="logo" href="/"><img class="img-fluid for-light" src="{{asset('backend/assets/images/logo/ma_general_logo.png')}}" alt="looginpage"><img class="img-fluid for-dark" src="{{asset('backend/assets/images/logo/logo_dark.png')}}" alt="looginpage"></a></div>
              <div class="login-main"> 
                  ...
                  <div class="form-group mb-0">
                    ...
                    </div><a class="link d-none" href="/forget-password" >Forgot password?</a>
                  ...
                  <p class="d-none mt-4 mb-0 text-center">Don't have account?<a class="ms-2" href="/signup">Create Account</a></p>
                </form>
              </div>
            </div>
          </div>
